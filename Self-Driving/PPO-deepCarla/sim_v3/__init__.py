'''
Summary: File to run when an env / sim is being set
 - start
 - start_local_env
 - add_recorder
 - monkey_patch_env_api
 - connect_to_unreal
'''
...
# We do not use deepdrive api
# from deepdrive_api.client import Client

# noinspection PyUnresolvedReferences
from sim_v3.action import gym_action as action
from sim_v3.driving_style import DrivingStyle
from sim_v3 import driving_style
from sim_v3.sim_args import SimArgs
from sim_v3.view_mode import ViewMode, ViewModeController
from sim_v3 import world
from recorder_v3.recorder import Recorder
...
register(
    id='Deepdrive-v0',
    entry_point='sim_v3.gym_env:DeepDriveEnv',
    kwargs=dict(),
)